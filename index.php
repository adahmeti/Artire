...
if(isset($_POST['sent'])){
	...
	$user=$_SESSION['id'];
	$bussines=$_POST['bussinss'];
	$subjekti=$_POST['subjekti'];
	$mesazhi=$_POST['mesazhi'];
	$sql=mysqli_query($con,"INSERT INTO `contact`(`user_id`, `seller_id`, `subject`, `message`) VALUES ('$user','$bussines','$subjekti','$mesazhi')");
...
<html lang="en">
	<head>
	    ...
	    <title>A R T I R E</title>

	    <!-- Bootstrap Core CSS -->
	    <link rel="stylesheet" href="assets/css/bootstrap.min.css">
	    
		<link rel="stylesheet" href="css/stylems.css">
...
<!-- ================================== TOP NAVIGATION : END ================================== -->
			...
			<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder" style="width:100%;">
				<!-- ========================================== SECTION – HERO ========================================= -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free shipping in Kosovo</h6>	
				</div>
			</div><!-- .col -->
