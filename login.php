...
<html lang="en">
	<head>
	    ...
	    <title>ARTIRE | Sign-in | Signup</title>
...
<div class="col-md-6 col-sm-6 create-new-account">
	<h4 class="checkout-subtitle"><a href="logins.php"> continue as seller </a></h4>
	<h4 class="checkout-subtitle">create user account</h4>
