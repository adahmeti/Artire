...
<h3 style="font-family:'bano">A R T E R I E</h3>
            </a>
        </div><!-- /.logo -->
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> 
           Your virtual artisanal products shopping mall
    </p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="">arterie@gmail.com</a></span>
                </div>
            </li>
